...
void r_4096_4_1024_128_16384_32_16384_128_16384_128_256_2_2_4(float* restrict data0_16384, float* restrict data2_1024, float* restrict data3_128, float* restrict data1_16384, float* restrict data4_128, float* restrict data5_16384, float* restrict data6_128, float* restrict data7_16384, float* restrict data8_128, float* restrict data9_256, float* restrict data10_2, float* restrict data11_2) {
  float buf0[1];
  *(buf0+0) = 0.0f;
  float buf1[1];
  *(buf1+0) = 0.0f;
  ...
  *(buf10+0) = 0.0f;
  ...
  for (int Ridx3 = 0; Ridx3 < 16384; Ridx3++) {
    float val2 = (*(data1_16384+Ridx3));
    *(buf8+0) = ((*(buf8+0))+(val2*val2));
  }
  for (int Ridx5 = 0; Ridx5 < 32; Ridx5++) {
    float4 val3 = (*((float4*)((data4_128+(Ridx5<<2)))));
  ...
  for (int Lidx16 = 0; Lidx16 < 4096; Lidx16++) {
    int alu33 = (Lidx16<<2);
    float4 val11 = (*((float4*)((data1_16384+alu33))));
    ...
    *((float4*)((data0_16384+alu33))) = (float4){(val11[0]*alu35),(val11[1]*alu35),(val11[2]*alu35),(val11[3]*alu35)};
  }
}
