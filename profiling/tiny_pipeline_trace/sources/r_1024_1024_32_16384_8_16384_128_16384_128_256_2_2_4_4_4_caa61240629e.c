...
void r_1024_1024_32_16384_8_16384_128_16384_128_256_2_2_4_4_4(float* restrict data0_1024, float* restrict data1_1024, float* restrict data2_128, float* restrict data3_16384, float* restrict data4_128, float* restrict data5_16384, float* restrict data6_128, float* restrict data7_16384, float* restrict data8_128, float* restrict data9_256, float* restrict data10_2, float* restrict data11_2) {
  float buf0[1];
  *(buf0+0) = 0.0f;
  float buf1[1];
  *(buf1+0) = 0.0f;
  ...
  *(buf10+0) = 0.0f;
  ...
  for (int Ridx2 = 0; Ridx2 < 32; Ridx2++) {
    float4 val1 = (*((float4*)((data2_128+(Ridx2<<2)))));
  ...
  for (int Lidx16 = 0; Lidx16 < 1024; Lidx16++) {
    float val14 = (*(data1_1024+Lidx16));
