...
void r_512_2_1024_128_16384_128_16384_128_16384_128_128_10000(float* restrict data0_1024, float* restrict data1_1024, float* restrict data2_128, float* restrict data3_16384, float* restrict data4_128, float* restrict data5_16384, float* restrict data6_128, float* restrict data7_16384, float* restrict data8_128, float* restrict data9_128, float* restrict data10_10000) {
  float buf0[1];
  *(buf0+0) = 0.0f;
  float buf1[1];
  *(buf1+0) = 0.0f;
  ...
  *(buf9+0) = 0.0f;
  ...
  for (int Lidx14 = 0; Lidx14 < 512; Lidx14++) {
    int alu30 = (Lidx14<<1);
    float2 val10 = (*((float2*)((data1_1024+alu30))));
    float val11 = (*(buf0+0));
    ...
    *((float2*)((data0_1024+alu30))) = (float2){(val10[0]*alu32),(val10[1]*alu32)};
  }
}
