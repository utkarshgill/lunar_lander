...
void r_4096_4_1024_128_16384_128_16384_128_16384_128_128_10000(float* restrict data0_16384, float* restrict data2_1024, float* restrict data3_128, float* restrict data4_16384, float* restrict data5_128, float* restrict data1_16384, float* restrict data6_128, float* restrict data7_16384, float* restrict data8_128, float* restrict data9_128, float* restrict data10_10000) {
  float buf0[1];
  *(buf0+0) = 0.0f;
  float buf1[1];
  *(buf1+0) = 0.0f;
