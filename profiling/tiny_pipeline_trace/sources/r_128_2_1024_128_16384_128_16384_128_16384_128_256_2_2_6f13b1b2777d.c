...
void r_128_2_1024_128_16384_128_16384_128_16384_128_256_2_2(float* restrict data0_256, float* restrict data2_1024, float* restrict data3_128, float* restrict data4_16384, float* restrict data5_128, float* restrict data6_16384, float* restrict data7_128, float* restrict data8_16384, float* restrict data9_128, float* restrict data1_256, float* restrict data10_2, float* restrict data11_2) {
  float buf0[1];
  *(buf0+0) = 0.0f;
  float buf1[1];
  *(buf1+0) = 0.0f;
  ...
  *(buf10+0) = 0.0f;
  ...
  for (int Lidx16 = 0; Lidx16 < 128; Lidx16++) {
    int alu33 = (Lidx16<<1);
    float2 val11 = (*((float2*)((data1_256+alu33))));
    ...
    *((float2*)((data0_256+alu33))) = (float2){(val11[0]*alu35),(val11[1]*alu35)};
  }
}
