...
void r_64_2_1024_32_16384_128_16384_128_16384_128_256_2_2_4(float* restrict data0_128, float* restrict data2_1024, float* restrict data3_128, float* restrict data4_16384, float* restrict data5_128, float* restrict data6_16384, float* restrict data1_128, float* restrict data7_16384, float* restrict data8_128, float* restrict data9_256, float* restrict data10_2, float* restrict data11_2) {
  float buf0[1];
  *(buf0+0) = 0.0f;
  float buf1[1];
  *(buf1+0) = 0.0f;
