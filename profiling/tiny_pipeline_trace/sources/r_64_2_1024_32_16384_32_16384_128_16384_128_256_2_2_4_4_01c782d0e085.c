...
void r_64_2_1024_32_16384_32_16384_128_16384_128_256_2_2_4_4(float* restrict data0_128, float* restrict data2_1024, float* restrict data3_128, float* restrict data4_16384, float* restrict data1_128, float* restrict data5_16384, float* restrict data6_128, float* restrict data7_16384, float* restrict data8_128, float* restrict data9_256, float* restrict data10_2, float* restrict data11_2) {
  float buf0[1];
  *(buf0+0) = 0.0f;
  float buf1[1];
  *(buf1+0) = 0.0f;
  ...
  *(buf10+0) = 0.0f;
  ...
  for (int Ridx2 = 0; Ridx2 < 32; Ridx2++) {
    ...
    *(buf9+0) = ((*(buf9+0))+(val1[0]*val1[0])+(val1[1]*val1[1])+(val1[2]*val1[2])+(val1[3]*val1[3]));
  }
  ...
  for (int Ridx5 = 0; Ridx5 < 32; Ridx5++) {
    ...
    *(buf7+0) = ((*(buf7+0))+(val3[0]*val3[0])+(val3[1]*val3[1])+(val3[2]*val3[2])+(val3[3]*val3[3]));
  }
  ...
  for (int Lidx16 = 0; Lidx16 < 64; Lidx16++) {
    int alu33 = (Lidx16<<1);
    float2 val11 = (*((float2*)((data1_128+alu33))));
    ...
    *((float2*)((data0_128+alu33))) = (float2){(val11[0]*alu35),(val11[1]*alu35)};
  }
}
